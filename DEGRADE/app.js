...
rangeInput.addEventListener("input", handeInclination);

function handeInclination() {
...
copyBtn.addEventListener("click", handleGradiantCopy);

let lock = false;
function handleGradiantCopy() {
